...
const[forms,setForms] = useState({stuff_id:'', total:'', date:'', proff_file:''})
...
const handleEditInbound = (event) =>{
    ...
    instance.put(`inbound/${id}`, formData)
    .then(res => {
        navigate('/inbound')
        Swal.fire({
            icon: 'success',
          ...
          <div className="block m-auto h-screen bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div className="items-center m-5 pb-10 pt-10">
                    ...
                    <div className="flex justify-center">
                        <h5 className="mb-1 ml-5 text-3xl font-medium text-gray-900 dark:text-white mb-10 text-shadow-blue">Edit Inbound Stuff</h5>
                    </div>
                    <form className="max-w-sm mx-auto" onSubmit={handleEditInbound}>
                    <div className="mb-5">
                        ...
                        <div className="mb-5">
                            ...
                            <input type="text" id="total" placeholder="Ketik Nama Barang"
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onChange={e => setForms({ ...forms, total: e.target.value })}  defaultValue={forms.total} required />
                        </div>
                        <div className="mb-5">
                            <label htmlFor="date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
                            <input type="date" id="date" placeholder="Ketik Nama Barang"
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                onChange={e => setForms({ ...forms, date: e.target.value })}  defaultValue={forms.date} required />
                        </div>
                        <div className="mb-5">
                            ...
                            <input type="file" id="proff_file" placeholder="Upload File" 
                                ...
                                onChange={e => setForms({ ...forms, proff_file: e.target.files[0] })}  defaultValue={forms.proff_file }required />
                        </div>
